  ...
  """
    ...
    def gen_core(self):
        ...
        filenames = calcdeps.CalculateDependencies(
            self.search_paths, [os.path.join("core", "blockly.js")])
    ...
    def gen_blocks(self):
        ...
        # Rinse and repeat for those in the the **other** blocks folder
        filenames = glob.glob(os.path.join("../../blocks", "*.js"))
        for filename in filenames:
            f = open(filename)
            params.append(("js_code", "".join(f.readlines())))
    ...
    def gen_generator(self, language):
        ...
        filenames = glob.glob(os.path.join("generators", language, "*.js"))
...
\\*/""")
            ...
            if original_b > 0 and compressed_b > 0:
                ...
                ratio = int(float(compressed_b) / float(original_b) * 100 +
                            0.5)
                print("SUCCESS: " + target_filename)
...
class Gen_langfiles(threading.Thread):
  ...
  """
    ...
    def _rebuild(self, srcs, dests):
        ...
        try:
            return (max(os.path.getmtime(src)
                        for src in srcs) > min(os.path.getmtime(dest)
                                               for dest in dests))
        except OSError as e:
    ...
    def run(self):
        ...
        if self._rebuild([os.path.join("msg", "messages.js")],
            ...
            try:
                subprocess.check_call([
                    "python", os.path.join("i18n",
                                           "js_to_json.py"), "--input_file",
                    "msg/messages.js", "--output_dir", "msg/json/", "--quiet"
                ])
        ...
        try:
            ...
            cmd = [
                ...
                "--source_synonym_file",
                os.path.join("msg", "json", "synonyms.json"), "--key_file",
                os.path.join("msg", "json", "keys.json"), "--output_dir",
                os.path.join("msg", "js"), "--quiet"
            ]
            json_files = glob.glob(os.path.join("msg", "json", "*.json"))
            json_files = [file for file in json_files if not (file.endswith((
                "keys.json", "synonyms.json", "qqq.json")))]
...
if __name__ == "__main__":
    try:
        calcdeps = import_path(os.path.join(
            os.path.pardir, "closure-library", "closure", "bin",
            "calcdeps.py"))
    except ImportError:
        if os.path.isdir(os.path.join(os.path.pardir,
        ...
        elif os.path.isdir(os.path.join(os.path.pardir,
